<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        {
            // insert
            if ($stmt = $mysqli->prepare("INSERT into clienti (username, Parola, email, Strada, Oras, Tara, CodPostal, NrCard, TipCard, DataExpCard, AcceptareEmail, Nume, NrInregRC, cod_fiscal) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?)"))
            {
